...
{	
	// displays sorted elements through Merge Sort
	public static void displayMergeSort()
	{
		...
		{	
			...
			if(length > 0)
			{
				...
				Utility.readIntArray(intArray, length);									// reads array
	...
	// dividing array into sub-arrays namely left array and right array through recursion
	// and merging them back after sorting elements
	...
	// merging the elements after sorting the elements
